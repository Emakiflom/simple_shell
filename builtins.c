 ...
 * 
 * Return: The function returns -1 to indicate to the main shell loop that the program should exit.
 */
int shell_exit(void)
{
    return (-1);
 ...
 * It uses the `environ` variable, which is an external variable containing the environment variables.
 * The function iterates through the `environ` array and prints each environment variable followed by a newline character.
 * 
